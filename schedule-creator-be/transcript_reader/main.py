...
def callback(ch, method, properties, body):
    print("Consumed message by transcript reader service")
    '''
    ######
    Transcript processing and uploading the remaining courses back to db
    ######
    '''
    ...
    try:
        ch.basic_publish(
            exchange='',
            routing_key=os.getenv('SCHEDULER_QUEUE'),
...
def main():
    ...
    channel.basic_consume(
        queue=os.getenv('TRANSCRIPT_QUEUE'),
